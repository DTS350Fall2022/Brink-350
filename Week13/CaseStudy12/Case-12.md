...
##    ...1 Date       AveragePrice `Total Volume` `4046` `4225` `4770` `Total Bags`
##   <dbl> <date>            <dbl>          <dbl>  <dbl>  <dbl>  <dbl>        <dbl>
## 1     6 2018-02-11         1.57         15986.  1924.  1368.     0        12694.
## 2     7 2018-02-04         1.63         17075.  2047.  1529.     0        13499.
## 3     8 2018-01-28         1.71         13888.  1192.  3432.     0         9265.
## 4     9 2018-01-21         1.87         13767.  1192.  2453.   728.        9394.
## 5    10 2018-01-14         1.93         16205.  1528.  2981.   727.       10970.
## 6    11 2018-01-07         1.62         17490.  2895.  2356.   225.       12014.
## # … with 6 more variables: `Small Bags` <dbl>, `Large Bags` <dbl>,
## #   `XLarge Bags` <dbl>, type <chr>, year <dbl>, region <chr>
```
...
##    ...1 Date       AveragePrice `Total Volume` `4046` `4225` `4770` `Total Bags`
##   <dbl> <date>            <dbl>          <dbl>  <dbl>  <dbl>  <dbl>        <dbl>
## 1     2 2015-12-13         1.03       2608448. 4.63e5 1.34e6 2.29e5      574072.
## 2     9 2015-10-25         1.1        2671536. 3.84e5 1.46e6 3.31e5      496813.
## 3    16 2015-09-06         1.07       3272555. 4.33e5 1.88e6 3.48e5      614943.
## 4    23 2015-07-19         1.12       3436864. 4.49e5 1.84e6 4.55e5      690083.
## 5    30 2015-05-31         1.2        3151714  6.67e5 1.48e6 2.80e5      725079.
## 6    37 2015-04-12         1.11       2895993. 5.49e5 1.40e6 1.90e5      754074.
## # … with 6 more variables: `Small Bags` <dbl>, `Large Bags` <dbl>,
## #   `XLarge Bags` <dbl>, type <chr>, year <dbl>, region <chr>
```
...
##    ...1 Date       AveragePrice `Total Volume` `4046` `4225` `4770` `Total Bags`
##   <dbl> <date>            <dbl>          <dbl>  <dbl>  <dbl>  <dbl>        <dbl>
## 1     0 2015-12-27         0.95      27297984. 9.63e6 1.02e7 1.18e6     6288852.
## 2     1 2015-12-20         0.98      25083647. 8.71e6 9.33e6 1.20e6     5842744.
## 3     2 2015-12-13         0.93      28041335. 9.86e6 1.08e7 1.02e6     6364280.
## 4     3 2015-12-06         0.89      28800397. 9.41e6 1.22e7 9.32e5     6302263.
## 5     4 2015-11-29         0.99      22617999. 8.09e6 9.00e6 7.31e5     4789009 
## 6     5 2015-11-22         0.96      25114228. 8.57e6 1.04e7 8.05e5     5347836.
## # … with 6 more variables: `Small Bags` <dbl>, `Large Bags` <dbl>,
## #   `XLarge Bags` <dbl>, type <chr>, year <dbl>, region <chr>
```
...
![](Case-12_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
...
![](Case-12_files/figure-html/unnamed-chunk-7-1.gif)<!-- -->
...
##    ...1 Date       AveragePrice `Total Volume` `4046` `4225` `4770` `Total Bags`
##   <dbl> <date>            <dbl>          <dbl>  <dbl>  <dbl>  <dbl>        <dbl>
## 1    34 2016-05-01         0.62       3863314. 1.36e6 1.05e6 9.86e4     1360962.
## 2    52 2017-01-01         0.84       3551337. 1.22e6 8.30e5 5.68e4     1441332.
## 3    26 2015-06-28         0.94       2921149. 2.07e6 4.19e5 7.58e4      353113.
## 4    20 2017-08-13         1.19       2832850. 1.41e6 4.53e5 1.21e5      846737.
## 5     2 2016-12-11         0.75       2793918. 9.17e5 6.31e5 5.96e4     1186206.
## 6    21 2015-08-02         1.14       1458723. 2.18e4 1.18e6 1.33e3      251358.
## # … with 6 more variables: `Small Bags` <dbl>, `Large Bags` <dbl>,
## #   `XLarge Bags` <dbl>, type <chr>, year <dbl>, region <chr>
```
